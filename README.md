...
Download the [lab1 instruction file](https://github.com/peerjako-aws/DEng-ID-Lab/blob/master/2-Lab-DMS.docx?raw=true)
...
Download the [lab2 instruction file](https://github.com/peerjako-aws/DEng-ID-Lab/blob/master/3-Lab-ETL_With_Glue.docx?raw=true) 
...
Download the [lab3 instruction file](https://github.com/peerjako-aws/DEng-ID-Lab/blob/master/4-Lab-Athena_Quicksight.docx?raw=true) 
...
Download the [lab4 instruction file](https://github.com/peerjako-aws/DEng-ID-Lab/blob/master/4-Lab-ML_using_Sagemaker.docx?raw=true) 
